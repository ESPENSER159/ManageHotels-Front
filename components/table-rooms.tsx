...
export default function TabelRooms({
  users,
  setLoading,
  IdHotel,
}: {
                ...
                <Form className="w-full" onSubmit={onSubmit}>
                  {action.action === "Eliminar" ? (
                    <div className="flex flex-col gap-2">
                      ...
                      <br />
                      <p className="text-default-500">
                        {action.rooms} habitación(es) de tipo {action.type} y
                        acomodación {action.accommodation}
                      </p>
                      <br />
                      <p className="text-default-500">
                    ...
                    <>
                      ...
                      <Select
                        isRequired
                        defaultSelectedKeys={
                          action.id_type && [String(action.id_type)]
                        }
                      ...
                      <Select
                        isRequired
                        defaultSelectedKeys={
                          action.id_accommodation && [
                            String(action.id_accommodation),
                          ]
                        }
                        errorMessage="Por favor seleccione el tipo de habitación"
                        label="Tipo de habitación"
                      ...
                      >
                        {accommodations.map((accommodation) => (
                          <SelectItem key={accommodation.key}>
                            {accommodation.label}
                          </SelectItem>
                        ))}
                      </Select>
